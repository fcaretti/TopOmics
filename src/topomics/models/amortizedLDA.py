...
from topomics.module._amortizedLDA import MultimodalAmortizedLDAPyroModule
from topomics.utils.training_plan import MultimodalLDAPyroTrainingPlan
    ...
    **Multimodal Amortized LDA with Mixture-of-Experts (MoE)**
    ...
    def setup_anndata(
        ...
        **kwargs,
        ...
        if modalities is not None or layers is not None or spatial_keys is not None:
            from topomics.data import extract_from_anndata
    ...
    def setup_data(
        ...
        **kwargs
        ...
        """
        from topomics.data import detect_data_type, validate_data_type
    ...
    def setup_mudata(
        ...
        **kwargs
        ...
        """
        from topomics.data import extract_from_mudata
    ...
    def get_modality_weights(
        ...
        if self.weight_mode == "equal":
            ...
            for tensors in dl:
                ...
                from topomics.module._amortizedLDA import masked_softmax
