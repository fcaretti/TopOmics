...
def parse_args():
    ...
    parser.add_argument("--max_epochs", type=int, default=200, help="Maximum training epochs (default: 500)")
    parser.add_argument("--batch_size", type=int, default=256, help="Batch size (default: 256)")
    parser.add_argument(
        "--output_dir", type=str, default="/data/topomics_models/atac_rna", help="Output directory for model and plots"
    )
